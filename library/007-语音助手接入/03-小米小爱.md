...
1.设置接入的设备类型
2.设置接入设备的auth Key  
3.设置SSID/PSWD 或者选择 ESPTOUCH等配网方式  
4.下载代码，等待设备接入上线成功  
...
### 示例代码:
[Arduino/ESP8266/ESP32示例](https://github.com/blinker-iot/blinker-library/blob/master/examples/Blinker_MIOT/MIOT_OUTLET/MIOT_OUTLET.ino)  
